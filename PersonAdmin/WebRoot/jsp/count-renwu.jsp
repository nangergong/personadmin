...
<script type="text/javascript">
	...
	function aa(){
		...
		window.location.href='timeAction!rwxx?goPage='+a;
    ...
    <td><table id="subtree1" style="DISPLAY: " width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr style="background-color: #80CE1A">
                    	<td height="50" colspan="9" align="center"  style="color: #E406E5;font-size:30px;font-weight: bold;background-image: url('../images/renwu1.jpg')" class="tablestyle_title"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日&nbsp;程&nbsp;列&nbsp;表 &nbsp;</td>
                    </tr>
              ...
              <td height="40" class="font42">
                <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  ...
                  <tr bgcolor="#EEEEEE">
                  	...
                  	<td width="25%" height="20" align="center"><s:property value="shortname"/></td>
                  	<td width="50%" align="center"><s:property value="represent"/></td>
                  	<td width="15%" align="center">
                  	<a href="${pageContext.request.contextPath}/find/timeAction!toUpdateTask?represent.id=<s:property value="id"/>">修改|</a>
                  	<a href="${pageContext.request.contextPath}/find/timeAction!deleteRenWu?id=<s:property value="id"/>">删除</a>
                  	</td>
                  </tr>
                  </s:iterator>
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="49%" align="right">[<a href="timeAction!rwxx?page.currentPage=1" class="right-font08">首页</a> |
                <s:if test="page.currentPage>1">
                 <a href="timeAction!rwxx?page.currentPage=${page.currentPage-1}" class="right-font08">上一页</a> |
                 </s:if>
                 <s:else>上一页</s:else>
                 <s:if test="page.currentPage< page.countPage">
                  <a href="timeAction!rwxx?page.currentPage=${page.currentPage+1}" class="right-font08">下一页</a> | 
                  </s:if>
                  <s:else>下一页</s:else>
                  <a href="timeAction!rwxx?page.currentPage=${page.countPage}" class="right-font08">末页</a>] 转至：</td>
                <td width="1%">
